  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        aria-invalid:border-destructive dark:bg-input/40 dark:hover:bg-input/50
        border-border bg-input flex w-fit items-center justify-between gap-2
        rounded-2xl border px-4 py-2 text-sm whitespace-nowrap
        transition-[color,box-shadow] outline-none focus-visible:ring-[3px]
        disabled:cursor-not-allowed disabled:opacity-50 data-[size=default]:h-11
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        ...
        [&_svg:not([class*='text-'])]:text-muted-foreground relative flex h-12
        w-full cursor-default items-center gap-2 rounded-sm py-2 pr-8 pl-4
