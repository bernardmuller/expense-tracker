    ...
    >
      <NavigationMenuPrimitive.Viewport
        ...
        className={cn(
          ...
          mt-1.5 h-[var(--radix-navigation-menu-viewport-height)] w-full
  ...
  return (
    <NavigationMenuPrimitive.Link
      ...
      className={cn(
        ...
        data-[active=true]:text-accent-foreground hover:bg-accent
  ...
  return (
    <NavigationMenuPrimitive.Indicator
      ...
      className={cn(
        ...
        data-[state=hidden]:fade-out data-[state=visible]:fade-in top-full z-[1]
