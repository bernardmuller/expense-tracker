...
function TabsList({
  ...
  return (
    <TabsPrimitive.List
      data-slot="tabs-list"
      className={cn(
        `bg-muted text-muted-foreground inline-flex h-12 w-fit items-center
