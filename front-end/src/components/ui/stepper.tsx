...
function StepperTrigger({
  ...
  return (
    <button
      ...
      className={cn(
        `focus-visible:border-ring focus-visible:ring-ring/50 inline-flex
        cursor-pointer items-center gap-3 rounded-full outline-none
        focus-visible:z-10 focus-visible:ring-[3px] disabled:pointer-events-none
        disabled:opacity-60`,
        className,
      )}
  ...
  return (
    <div
      ...
      className={cn(
        ...
        data-[state=active]:text-primary-foreground relative flex size-6
...
function StepperNav({ children, className }: React.ComponentProps<'nav'>) {
  ...
  return (
    <nav
      ...
      data-orientation={orientation}
      className={cn(
        `group/stepper-nav inline-flex data-[orientation=horizontal]:w-full
