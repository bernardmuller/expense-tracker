  ...
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      <div className="absolute inset-x-0 top-0 flex justify-center px-4">
        <div className="relative w-full max-w-[280px] sm:max-w-[240px] md:max-w-[380px] lg:max-w-[420px] xl:max-w-[420px] mt-4 sm:mt-8 md:mt-12 rounded-2xl overflow-hidden border border-border/30 shadow-2xl shadow-black/50">
          <video
            ref={videoRef}
            autoPlay
            loop
